...
using PuppySharpPdf.Standard.Renderers;
using PuppySharpPdf.Standard.Tests.Resources;
using Shouldly;

namespace PuppySharpPdf.Standard.Tests.Common.RendererTests;
public class PuppyPdfRendererTests
{
    ...
    public async Task GeneratePdfFromUrlAsync_CustomPdfOptions_ShouldReturnNonEmptyByteArray()
    {
        ...
        {
            options.Format = PuppySharpPdf.Standard.Renderers.Configurations.PaperFormat.Letter;
